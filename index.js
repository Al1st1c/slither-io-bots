...
var spawnBuf2 = new Uint8Array([115,10,getRandomInt(0, 42),15,32,99,104,101,97,116,100,117,111,46,105,111]);

console.log(spawnBuf2)
...
Bot.prototype = {
	...
	// var spawnBuf = [115,10,39,15,32,99,104,101,97,116,100,117,111,46,105,111]
	var spawnBuf = new Uint8Array([115,10,getRandomInt(0, 42),15,32,99,104,101,97,116,100,117,111,46,105,111]);
...
io.on('connection', function(socket) {
  ...
  var address = socket.request.connection.remoteAddress;
	...
	socket.on('start', function(data) {
		...
		console.log('CheatDuo Bots has succesfully started!');
	});
...
try{
asciiArt.font('cheatduo.io', 'Doom', function(rendered){
